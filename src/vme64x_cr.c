...
#include <vme.h>
/*#include  </afs/psi.ch/user/k/korhonen/vxw/Tornado2.2/target/config/mv5100/universe.h>
#include  </afs/psi.ch/user/k/korhonen/vxw/Tornado2.2/target/config/mv5100/mv5100.h> */
#include  </export/home/vxworks/tornado/target/config/mv5100timing/universe.h>
#include  </export/home/vxworks/tornado/target/config/mv5100timing/mv5100.h>
#include "vme64x_cr.h"
#ifndef UNIV_IN_LONG
...
printf("board_id %X\n", slot_board_id);
printf("ieee_oui %X\n", slot_ieee_oui);  /*leige debug 2005 Nov 9*/
